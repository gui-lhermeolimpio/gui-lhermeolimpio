...
Atualmente, sou estagiário em Web Design na CasaH, onde trabalho com edição de imagens para o e-commerce da empresa. Também atuei como designer gráfico na AssertTech, criando criativos para empresas e redes-sociais, além disso, também tenho experiência anterior na Expecto System com Desenvolvimento Flutter, utilizando Dart como linguagem de programação para o design e implementação de funcionalidades no sistema da empresa. e suporte a sistemas ERP. <br></br>
